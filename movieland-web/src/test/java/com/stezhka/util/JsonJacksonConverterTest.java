...
public class JsonJacksonConverterTest {
    ...
    public void testMovieToJson() {
        ...
        String json = "[{\"id\":1,\"nameRussian\":\"ТестФильм1\",\"nameNative\":\"TestMovie1\",\"yearOfRelease\":1984,\"description\":\"description1\",\"rating\":9.5,\"price\":100.5,\"poster\":\"http://posterfilm1.com\",\"votes\":100,\"countries\":[{\"id\":1,\"countryName\":\"USSR\"}],\"genres\":[{\"id\":1,\"name\":\"horror\"}]}]";
